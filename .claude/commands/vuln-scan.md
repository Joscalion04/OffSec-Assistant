...
Si AUTO_MODE es true:
  ...
  2. Verifica que existe recon previo en findings/<engagement>/recon/
     Si no hay recon: "⚠️ No hay recon previo — ¿ejecutar /recon $TARGET -auto primero?"
  3. Informa:
  ...
  4. Ejecuta:
     bash /home/joseph/Documents/OffSec/OffSec-Assistant/tools/run-vuln-scan.sh <engagement> $TARGET
