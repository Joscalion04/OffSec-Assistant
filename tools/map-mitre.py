...
TECHNIQUE_DB = {
    ...
    "osint": {
        ...
        "tactic": "Reconnaissance", "sub": None,
    ...
    "sql injection": {
        ...
        "tactic": "Initial Access", "sub": None,
    ...
    "privilege escalation": {
        ...
        "tactic": "Privilege Escalation", "sub": None,
    ...
    "scheduled task": {
        ...
        "tactic": "Privilege Escalation", "sub": "005",
        "url": "https://attack.mitre.org/techniques/T1053/005/"
    },
    "dll hijacking": {
        "id": "T1574.001", "name": "Hijack Execution Flow: DLL Search Order Hijacking",
        "tactic": "Privilege Escalation", "sub": "001",
        "url": "https://attack.mitre.org/techniques/T1574/001/"
    },
    "path hijacking": {
        "id": "T1574.007", "name": "Hijack Execution Flow: Path Interception",
        "tactic": "Privilege Escalation", "sub": "007",
        "url": "https://attack.mitre.org/techniques/T1574/007/"
    },
    "token impersonation": {
        "id": "T1134.001", "name": "Access Token Manipulation: Token Impersonation/Theft",
        "tactic": "Privilege Escalation", "sub": "001",
    ...
    "brute force": {
        ...
        "tactic": "Credential Access", "sub": None,
        "url": "https://attack.mitre.org/techniques/T1110/"
    },
    "password spraying": {
        "id": "T1110.003", "name": "Brute Force: Password Spraying",
        "tactic": "Credential Access", "sub": "003",
    ...
    "ntlm": {
        ...
        "tactic": "Credential Access", "sub": "002",
        "url": "https://attack.mitre.org/techniques/T1003/002/"
    },
    "lsass": {
        "id": "T1003.001", "name": "OS Credential Dumping: LSASS Memory",
        "tactic": "Credential Access", "sub": "001",
    ...
    "as-rep roasting": {
        ...
        "tactic": "Credential Access", "sub": "004",
    ...
    "pass the hash": {
        ...
        "tactic": "Lateral Movement", "sub": "002",
    ...
    "lateral movement": {
        ...
        "tactic": "Lateral Movement", "sub": None,
    ...
    "winrm": {
        ...
        "tactic": "Lateral Movement", "sub": "006",
...
def main():
    ...
    parser.add_argument("query", nargs="?", help="Término a buscar (ej: 'sql injection', 'rce')")
    parser.add_argument("--finding", help="Archivo finding_*.md para análisis automático")
    parser.add_argument("--list-tactics", action="store_true", help="Lista todas las tácticas disponibles")
    ...
    if not results:
        print(f"[MITRE] Sin coincidencias para: {args.query or args.finding}", file=sys.stderr)
        sys.exit(1)
